define([
  ...
  'apollo-utilities',
  './graphql',
], function(require, exports, tslib_1, apollo_utilities_1, graphql_1) {
  'use strict';
              ...
              return tslib_1.__awaiter(_this, void 0, void 0, function() {
                ...
                return tslib_1.__generator(this, function(_a) {
                  switch (_a.label) {
                    case 0:
                      if (
                        !apollo_utilities_1.shouldInclude(selection, variables)
                      ) {
                        return [2];
                      }
                    ...
                    case 1:
                      fieldResult = _a.sent();
                      resultFieldKey = apollo_utilities_1.resultKeyNameFromField(
                        selection,
                      );
      ...
      return tslib_1.__generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            ...
            args = apollo_utilities_1.argumentsObjectFromField(
              field,
              variables,
            );
            info = {
