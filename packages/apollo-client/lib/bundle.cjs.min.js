...
var e,
  t,
  r = require('tslib'),
  o = require('apollo-utilities'),
  n = require('apollo-link'),
  i = (e = require('symbol-observable')) && e.__esModule ? e : { default: e },
  s = require('ts-invariant'),
  a = require('graphql/language/visitor');
function u(e) {
  return e < 7;
}
(exports.NetworkStatus = t),
  (function(e) {
...
var v = (function(e) {
  function n(t) {
    ...
    (a.observers = new Set()),
      ...
      (a.shouldSubscribe = s);
    var u = (0, o.getOperationDefinition)(n.query);
    return (a.queryName = u && u.name && u.name.value), (a.queryManager = r), a;
  }
  return (
    (0, r.__extends)(n, e),
    ...
    (n.prototype.getCurrentResult = function() {
      ...
      var o,
        n,
        i,
        s = this.queryManager.getCurrentQueryResult(this),
        a = s.data,
        c = s.partial,
        h = this.queryManager.queryStore.get(this.queryId),
        p = this.options.fetchPolicy,
        y = 'network-only' === p || 'no-cache' === p;
      if (h) {
        var v = h.networkStatus;
        if (
          ((n = h),
          void 0 === (i = this.options.errorPolicy) && (i = 'none'),
          n && (n.networkError || ('none' === i && l(n.graphQLErrors))))
        )
          return {
            data: void 0,
            loading: !1,
            ...
            error: new f({
              ...
              networkError: h.networkError,
            }),
          };
        h.variables &&
          ((this.options.variables = (0, r.__assign)(
            {},
            this.options.variables,
            h.variables,
          )),
          (this.variables = this.options.variables)),
          (o = { data: a, loading: u(v), networkStatus: v }),
          h.graphQLErrors &&
            'all' === this.options.errorPolicy &&
            (o.errors = h.graphQLErrors);
      } else {
        var d = y || (c && 'cache-only' !== p);
        o = { data: a, loading: d, networkStatus: d ? t.loading : t.ready };
      }
      return (
        c || this.updateLastResult((0, r.__assign)({}, o, { stale: !1 })),
        (0, r.__assign)({}, o, { partial: c })
      );
    }),
    ...
    (n.prototype.refetch = function(e) {
      ...
      return 'cache-only' === t
        ? Promise.reject(new s.InvariantError(3))
        : ('no-cache' !== t &&
            'cache-and-network' !== t &&
            (t = 'network-only'),
          (0, o.isEqual)(this.variables, e) ||
            (this.variables = (0, r.__assign)({}, this.variables, e)),
          (0, o.isEqual)(this.options.variables, this.variables) ||
            (this.options.variables = (0, r.__assign)(
              {},
              this.options.variables,
              this.variables,
          ...
          this.queryManager.fetchQuery(
            this.queryId,
            (0, r.__assign)({}, this.options, { fetchPolicy: t }),
            p.refetch,
          ));
    }),
    (n.prototype.fetchMore = function(e) {
      var t = this;
      (0, s.invariant)(e.updateQuery, 4);
      var o = (0, r.__assign)(
          {},
          e.query
            ? e
            : (0, r.__assign)({}, this.options, e, {
                variables: (0, r.__assign)({}, this.variables, e.variables),
              }),
          { fetchPolicy: 'network-only' },
        ),
        n = this.queryManager.generateQueryId();
      return this.queryManager.fetchQuery(n, o, p.normal, this.queryId).then(
        function(r) {
          return (
    ...
    (n.prototype.setOptions = function(e) {
      var t = this.options.fetchPolicy;
      (this.options = (0, r.__assign)({}, this.options, e)),
        e.pollInterval
      ...
      return this.setVariables(
        this.options.variables,
        t !== o &&
          ('cache-only' === t || 'standby' === t || 'network-only' === o),
        e.fetchResults,
      );
    }),
    (n.prototype.setVariables = function(e, t, r) {
      return (
        void 0 === t && (t = !1),
        void 0 === r && (r = !0),
        (this.isTornDown = !1),
        (e = e || this.variables),
        !t && (0, o.isEqual)(e, this.variables)
    ...
    (n.prototype.updateQuery = function(e) {
      var t = this.queryManager,
        ...
        i = r.variables,
        s = r.document,
        a = (0, o.tryFunctionOrLogError)(function() {
          return e(n, { variables: i });
        });
      a && (t.dataStore.markUpdateQueryResult(s, i, a), t.broadcastQueries());
    }),
    ...
    (n.prototype.setUpQuery = function() {
      ...
      this.shouldSubscribe && n.addObservableQuery(i, this),
        this.options.pollInterval &&
          (m(this), n.startPollingQuery(this.options, i));
      var s = function(o) {
        e.updateLastResult(
          (0, r.__assign)({}, e.lastResult, {
            errors: o.graphQLErrors,
            networkStatus: t.error,
            loading: !1,
          }),
        ),
          b(e.observers, 'error', (e.lastError = o));
      };
      n.observeQuery(i, this.options, {
        next: function(t) {
          if (e.lastError || e.isDifferentFromLastResult(t)) {
            var r = e.updateLastResult(t),
              i = e.options,
              s = i.query,
              a = i.variables,
              u = i.fetchPolicy;
...
function m(e) {
  ...
  (0, s.invariant)('cache-first' !== t && 'cache-only' !== t, 5);
}
exports.ObservableQuery = v;
var g = (function() {
    function e() {
      this.store = {};
    }
  ...
  Q = (function() {
    ...
    return (
      ...
      (e.prototype.initQuery = function(e) {
        var r = this.store[e.queryId];
        (0, s.invariant)(
          !r ||
            r.document === e.document ||
            (0, o.isEqual)(r.document, e.document),
          19,
        );
        var n,
          i = !1,
        ...
        e.storePreviousVariables &&
          r &&
          r.networkStatus !== t.loading &&
          ((0, o.isEqual)(r.variables, e.variables) ||
            ((i = !0), (a = r.variables))),
          (n = i
            ? t.setVariables
            : e.isPoll
            ...
            : t.loading);
        var u = [];
        r && r.graphQLErrors && (u = r.graphQLErrors),
          ...
          'string' == typeof e.fetchMoreForQueryId &&
            ...
            (this.store[e.fetchMoreForQueryId].networkStatus = t.fetchMore);
      }),
      (e.prototype.markQueryResult = function(e, r, o) {
        this.store &&
          this.store[e] &&
          ((this.store[e].networkError = null),
          (this.store[e].graphQLErrors = l(r.errors) ? r.errors : []),
          (this.store[e].previousVariables = null),
          (this.store[e].networkStatus = t.ready),
          'string' == typeof o &&
            this.store[o] &&
            (this.store[o].networkStatus = t.ready));
      }),
      (e.prototype.markQueryError = function(e, r, o) {
        this.store &&
          this.store[e] &&
          ((this.store[e].networkError = r),
          (this.store[e].networkStatus = t.error),
          'string' == typeof o && this.markQueryResultClient(o, !0));
      }),
      (e.prototype.markQueryResultClient = function(e, r) {
        var o = this.store && this.store[e];
        o &&
          ((o.networkError = null),
          (o.previousVariables = null),
          r && (o.networkStatus = t.ready));
      }),
      ...
      (e.prototype.reset = function(e) {
        ...
        Object.keys(this.store).forEach(function(o) {
          e.indexOf(o) < 0
            ? r.stopQuery(o)
            : (r.store[o].networkStatus = t.loading);
        });
      }),
      e
    );
  ...
  return (
    (e.prototype.addResolvers = function(e) {
      ...
      (this.resolvers = this.resolvers || {}),
        Array.isArray(e)
          ? e.forEach(function(e) {
              t.resolvers = (0, o.mergeDeep)(t.resolvers, e);
            })
          : (this.resolvers = (0, o.mergeDeep)(this.resolvers, e));
    }),
          ...
          return t
            ? [
                ...
                this.resolveDocument(
                  ...
                  return (0, r.__assign)({}, o, { data: e.result });
                }),
              ]
            : [2, o];
        });
    ...
    (e.prototype.clientQuery = function(e) {
      return (0, o.hasDirectives)(['client'], e) && this.resolvers ? e : null;
    }),
    (e.prototype.serverQuery = function(e) {
      return this.resolvers ? (0, o.removeClientSetsFromDocument)(e) : e;
    }),
    ...
    (e.prototype.addExportedVariables = function(e, t, o) {
      return (
        void 0 === t && (t = {}),
        void 0 === o && (o = {}),
            ...
            return e
              ? [
                  ...
                  this.resolveDocument(
                    ...
                    return (0, r.__assign)({}, t, e.exportedVariables);
                  }),
                ]
              : [2, (0, r.__assign)({}, t)];
          });
    ...
    (e.prototype.buildRootValueFromCache = function(e, t) {
      return this.cache.diff({
        query: (0, o.buildQueryFromSelectionSet)(e),
        variables: t,
        returnPartialData: !0,
        optimistic: !1,
      }).result;
    }),
    (e.prototype.resolveDocument = function(e, t, n, i, s, a) {
      return (
        void 0 === n && (n = {}),
        void 0 === i && (i = {}),
        void 0 === s &&
        ...
        (0, r.__awaiter)(this, void 0, void 0, function() {
          ...
          return (0, r.__generator)(this, function(b) {
            var m;
            return (
              (u = (0, o.getMainDefinition)(e)),
              (c = (0, o.getFragmentDefinitions)(e)),
              (l = (0, o.createFragmentMap)(c)),
              (h = u.operation),
              (p = h ? (m = h).charAt(0).toUpperCase() + m.slice(1) : 'Query'),
              (f = (y = this).cache),
              (v = y.client),
              (d = {
                fragmentMap: l,
                context: (0, r.__assign)({}, n, { cache: f, client: v }),
                variables: i,
                fragmentMatcher: s,
              ...
              [
                2,
                this.resolveSelectionSet(u.selectionSet, t, d).then(function(
                  e,
                ) {
      ...
      return (0, r.__awaiter)(this, void 0, void 0, function() {
        ...
        return (0, r.__generator)(this, function(p) {
          return (
            ...
            (c = [t]),
            (l = function(e) {
              return (0, r.__awaiter)(h, void 0, void 0, function() {
                var l, h;
                return (0, r.__generator)(this, function(r) {
                  return (0, o.shouldInclude)(e, u)
                    ? (0, o.isField)(e)
                      ? [
                          2,
                          this.resolveField(e, t, n).then(function(t) {
                            ...
                            void 0 !== t &&
                              c.push(
                                (((r = {})[
                                  (0, o.resultKeyNameFromField)(e)
                                ] = t),
                                r),
                              );
                          }),
                        ]
                      : ((0, o.isInlineFragment)(e)
                          ? (l = e)
                          : ((l = i[e.name.value]), (0, s.invariant)(l, 7)),
                        l &&
                        l.typeCondition &&
                        ((h = l.typeCondition.name.value),
                        n.fragmentMatcher(t, h, a))
                          ? [
                              2,
      ...
      return (0, r.__awaiter)(this, void 0, void 0, function() {
        ...
        return (0, r.__generator)(this, function(r) {
          return (
            (i = n.variables),
            (s = e.name.value),
            (a = (0, o.resultKeyNameFromField)(e)),
            (u = s !== a),
            (c = t[a] || t[s]),
            (l = Promise.resolve(c)),
            (n.onlyRunForcedResolvers && !this.shouldForceResolvers(e)) ||
              ((h = t.__typename || n.defaultOperationType),
              (p = this.resolvers && this.resolvers[h]) &&
                (y = p[u ? s : a]) &&
                (l = Promise.resolve(
                  y(t, (0, o.argumentsObjectFromField)(e, i), n.context, {
                    field: e,
                  }),
                ))),
            [
  ...
  R = (function() {
    function e(e) {
      ...
      (this.mutationStore = new g()),
        (this.queryStore = new Q()),
        (this.clientAwareness = {}),
        (this.idCounter = 1),
        (this.queries = new Map()),
        (this.fetchQueryRejectFns = new Map()),
        (this.transformCache = new (o.canUseWeakMap ? WeakMap : Map)()),
    ...
    return (
      ...
      (e.prototype.mutate = function(e) {
        ...
        return (0, r.__awaiter)(this, void 0, void 0, function() {
          var e,
            ...
            h,
            v = this;
          return (0, r.__generator)(this, function(m) {
            switch (m.label) {
              case 0:
                return (
                  (0, s.invariant)(t, 9),
                  (0, s.invariant)(!b || 'no-cache' === b, 10),
                  ...
                  [
                    ...
                    new Promise(function(s, a) {
                      ...
                      h.getObservableFromLink(
                        t,
                        (0, r.__assign)({}, g, { optimisticResponse: i }),
                        n,
                        !1,
                      ).subscribe({
                        next: function(r) {
                          (0, o.graphQLResultHasError)(r) && 'none' === d
                            ? (m = new f({ graphQLErrors: r.errors }))
      ...
      (e.prototype.fetchQuery = function(e, t, n, i) {
        return (0, r.__awaiter)(this, void 0, void 0, function() {
          var s,
            a,
            u,
            ...
            switch (I.label) {
              case 0:
                return (
                  ...
                  (d = this.getVariables(v, t.variables)),
              ...
              case 2:
                if (
                  ...
                  (0, o.hasDirectives)(['live'], v) && (q = !0),
                  (R = this.idCounter++),
                  (k =
                    'no-cache' !== c ? this.updateQueryWatch(e, v, t) : void 0),
                  this.setQuery(e, function() {
                    return {
                      document: v,
                      lastRequestId: R,
      ...
      (e.prototype.markQueryResult = function(e, t, r, o) {
        var n = r.fetchPolicy,
          i = r.variables,
          s = r.errorPolicy;
        'no-cache' === n
            ...
            if ('standby' !== h) {
              ...
              if (!p || d) {
                var b = l(r.graphQLErrors),
                  m = (a && a.options.errorPolicy) || t.errorPolicy || 'none';
                ...
                try {
                  ...
                  var R = Q && !(t.returnPartialData || 'cache-only' === h),
                    k = {
                      data: R ? y && y.data : g,
                      loading: p,
      ...
      (e.prototype.transform = function(e) {
        ...
        if (!t.has(e)) {
          var r = this.dataStore.getCache(),
            ...
            i = (0, o.removeConnectionDirectiveFromDocument)(
              r.transformForLink(n),
            ),
            s = this.localState.clientQuery(n),
            a = this.localState.serverQuery(i),
            u = {
              document: n,
              hasClientExports: (0, o.hasClientExports)(n),
              hasForcedResolvers: this.localState.shouldForceResolvers(n),
              clientQuery: s,
              serverQuery: a,
              defaultVars: (0, o.getDefaultValues)(
                (0, o.getOperationDefinition)(n),
              ),
            },
            c = function(e) {
              e && !t.has(e) && t.set(e, u);
      ...
      (e.prototype.getVariables = function(e, t) {
        return (0, r.__assign)({}, this.transform(e).defaultVars, t);
      }),
      (e.prototype.watchQuery = function(e, t) {
        void 0 === t && (t = !0),
          (0, s.invariant)('standby' !== e.fetchPolicy, 11),
        ...
        return new v({ queryManager: this, options: o, shouldSubscribe: t });
      }),
      (e.prototype.query = function(e) {
        var t = this;
        return (
          (0, s.invariant)(e.query, 12),
          (0, s.invariant)('Document' === e.query.kind, 13),
          (0, s.invariant)(!e.returnPartialData, 14),
          (0, s.invariant)(!e.pollInterval, 15),
          new Promise(function(r, o) {
            ...
            t.fetchQueryRejectFns.set('query:' + n.queryId, o),
              n
                ...
                .then(r, o)
                .then(function() {
                  return t.fetchQueryRejectFns.delete('query:' + n.queryId);
                });
          })
        );
      }),
      ...
      (e.prototype.observeQuery = function(e, t, r) {
        return (
          this.addQueryListener(e, this.queryListenerForObserver(e, t, r)),
          this.fetchQuery(e, t)
        );
      }),
      ...
      (e.prototype.startGraphQLSubscription = function(e) {
        ...
        if (this.transform(r).hasClientExports) {
          var a = this.localState.addExportedVariables(r, i).then(s);
      ...
      (e.prototype.getObservableFromLink = function(e, t, i, s) {
        var a,
          u = this;
        ...
        if (l) {
          var h = this.inFlightLinkObservables,
            ...
            y = {
              query: l,
              variables: i,
              operationName: (0, o.getOperationName)(l) || void 0,
              context: this.prepareContext(
                (0, r.__assign)({}, t, { forceFetch: !s }),
              ),
            };
          if (((t = y.context), s)) {
            ...
            if (!(a = f.get(v))) {
              f.set(v, (a = S((0, n.execute)(p, y))));
              var d = function() {
                  f.delete(v), f.size || h.delete(l), b.unsubscribe();
                },
                b = a.subscribe({ next: d, error: d, complete: d });
            }
          } else a = S((0, n.execute)(p, y));
        } else (a = c.of({ data: {} })), (t = this.prepareContext(t));
          ...
          var m = function() {
            ...
            g = d
              .map(function(e) {
                ...
                if (('all' === y && (o = e.errors), c || 'no-cache' === v))
                  r = e.data;
                else {
                  var t = n.dataStore
                      .getCache()
      ...
      (e.prototype.checkInFlight = function(e) {
        var r = this.queryStore.get(e);
        return r && r.networkStatus !== t.ready && r.networkStatus !== t.error;
      }),
      (e.prototype.startPollingQuery = function(e, t, o) {
        var n = this,
          i = e.pollInterval;
        if (((0, s.invariant)(i, 18), !this.ssrMode)) {
          var a = this.pollingInfoByQueryId.get(t);
          a || this.pollingInfoByQueryId.set(t, (a = {})),
            (a.interval = i),
            (a.options = (0, r.__assign)({}, e, {
              fetchPolicy: 'network-only',
            }));
          var u = function() {
              ...
              e &&
                (n.checkInFlight(t)
                  ? c()
                  : n.fetchQuery(t, e.options, p.poll).then(c, c));
            },
            c = function() {
              var e = n.pollingInfoByQueryId.get(t);
              e &&
  ...
  k = (function() {
    ...
    return (
      ...
      (e.prototype.markQueryResult = function(e, t, r, n, i) {
        void 0 === i && (i = !1);
        var s = !(0, o.graphQLResultHasError)(e);
        i && (0, o.graphQLResultHasError)(e) && e.data && (s = !0),
          !n &&
            s &&
            this.cache.write({
              result: e.data,
      ...
      (e.prototype.markMutationResult = function(e) {
        var t = this;
        if (!(0, o.graphQLResultHasError)(e.result)) {
          var r = [
              {
          ...
          n &&
            Object.keys(n).forEach(function(i) {
              var s = n[i],
                ...
                l = c.result;
              if (c.complete) {
                var h = (0, o.tryFunctionOrLogError)(function() {
                  return u(l, {
                    mutationResult: e.result,
                    queryName: (0, o.getOperationName)(a.document) || void 0,
            ...
            this.cache.performTransaction(function(t) {
              ...
              var n = e.update;
              n &&
                (0, o.tryFunctionOrLogError)(function() {
                  return n(t, e.result);
                });
            });
        }
  ...
  _ = (function() {
    function e(e) {
      ...
      var r = e.cache,
        ...
        g = e.version,
        Q = e.link;
      if ((!Q && v && (Q = n.ApolloLink.empty()), !Q || !r))
        throw new s.InvariantError(1);
      (this.link = Q),
        (this.cache = r),
        (this.store = new k(r)),
    ...
    return (
      ...
      (e.prototype.watchQuery = function(e) {
        return (
          this.defaultOptions.watchQuery &&
            (e = (0, r.__assign)({}, this.defaultOptions.watchQuery, e)),
          !this.disableNetworkFetches ||
            ('network-only' !== e.fetchPolicy &&
              'cache-and-network' !== e.fetchPolicy) ||
            (e = (0, r.__assign)({}, e, { fetchPolicy: 'cache-first' })),
      ...
      (e.prototype.query = function(e) {
        return (
          this.defaultOptions.query &&
            (e = (0, r.__assign)({}, this.defaultOptions.query, e)),
          (0, s.invariant)('cache-and-network' !== e.fetchPolicy, 2),
          this.disableNetworkFetches &&
            'network-only' === e.fetchPolicy &&
            (e = (0, r.__assign)({}, e, { fetchPolicy: 'cache-first' })),
      ...
      (e.prototype.mutate = function(e) {
        return (
          this.defaultOptions.mutate &&
            (e = (0, r.__assign)({}, this.defaultOptions.mutate, e)),
      ...
      (e.prototype.__requestRaw = function(e) {
        return (0, n.execute)(this.link, e);
      }),
