define(['require', 'exports'], function(require, exports) {
  ...
  function observableToPromiseAndSubscription(_a) {
    var observable = _a.observable,
      _b = _a.shouldResolve,
      shouldResolve = _b === void 0 ? true : _b,
      _c = _a.wait,
      wait = _c === void 0 ? -1 : _c,
      _d = _a.errorCallbacks,
      errorCallbacks = _d === void 0 ? [] : _d;
    var cbs = [];
      ...
      subscription = observable.subscribe({
        next: function(result) {
          ...
          if (cb) {
            ...
            reject(
              new Error('Observable called more than ' + cbs.length + ' times'),
            );
          }
        },
  ...
  function default_1(options) {
    ...
    return observableToPromiseAndSubscription.apply(
      void 0,
      [options].concat(cbs),
    ).promise;
  }
