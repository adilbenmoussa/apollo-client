  ...
  var QueryStore = (function() {
    ...
    QueryStore.prototype.initQuery = function(query) {
      ...
      if (
        ...
        if (
          !apollo_utilities_1.isEqual(previousQuery.variables, query.variables)
        ) {
          isSetVariables = true;
    ...
    QueryStore.prototype.markQueryResult = function(
      ...
      this.store[queryId].graphQLErrors = arrays_1.isNonEmptyArray(
        result.errors,
      )
        ? result.errors
        : [];
    ...
    QueryStore.prototype.reset = function(observableQueryIds) {
      ...
      Object.keys(this.store).forEach(function(queryId) {
        if (observableQueryIds.indexOf(queryId) < 0) {
          ...
          _this.store[queryId].networkStatus =
