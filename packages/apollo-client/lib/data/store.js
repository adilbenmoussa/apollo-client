define(['require', 'exports', 'apollo-utilities'], function(
  require,
  exports,
  apollo_utilities_1,
) {
      ...
      if (!apollo_utilities_1.graphQLResultHasError(mutation.result)) {
        ...
        if (updateQueries_1) {
          Object.keys(updateQueries_1).forEach(function(id) {
            ...
            if (complete) {
              var nextQueryResult = apollo_utilities_1.tryFunctionOrLogError(
                function() {
                  return updater(currentQueryResult, {
                    mutationResult: mutation.result,
                    queryName:
                      apollo_utilities_1.getOperationName(query.document) ||
                      undefined,
