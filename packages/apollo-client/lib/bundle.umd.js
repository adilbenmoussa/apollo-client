(function(global, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(
      mod.exports,
      global.tslib,
      global.apolloUtilities,
      global.apolloLink,
      global.symbolObservable,
      global.tsInvariant,
      global.visitor,
    );
  ...
  var ObservableQuery = (function(_super) {
    ...
    ObservableQuery.prototype.getCurrentResult = function() {
      ...
      if (queryStoreValue) {
        ...
        if (queryStoreValue.variables) {
          this.options.variables = (0, _tslib.__assign)(
            {},
    ...
    ObservableQuery.prototype.isDifferentFromLastResult = function(newResult) {
      ...
      return !(
        ...
        (0, _apolloUtilities.isEqual)(snapshot.data, newResult.data)
      );
    };
    ...
    ObservableQuery.prototype.refetch = function(variables) {
      ...
      if (fetchPolicy === 'cache-only') {
        return Promise.reject(
          process.env.NODE_ENV === 'production'
            ? new _tsInvariant.InvariantError(3)
            : new _tsInvariant.InvariantError(
      ...
      if (
        !(0, _apolloUtilities.isEqual)(this.options.variables, this.variables)
      ) {
        this.options.variables = (0, _tslib.__assign)(
          {},
          this.options.variables,
      ...
      return this.queryManager.fetchQuery(
        this.queryId,
        (0, _tslib.__assign)({}, this.options, {
    ...
    ObservableQuery.prototype.fetchMore = function(fetchMoreOptions) {
      ...
      process.env.NODE_ENV === 'production'
        ? (0, _tsInvariant.invariant)(fetchMoreOptions.updateQuery, 4)
        : (0, _tsInvariant.invariant)(
            fetchMoreOptions.updateQuery,
            'updateQuery option is required. This function defines how to update the query data with the new results.',
          );
      var combinedOptions = (0, _tslib.__assign)(
        {},
        fetchMoreOptions.query
          ? fetchMoreOptions
          : (0, _tslib.__assign)({}, this.options, fetchMoreOptions, {
              variables: (0, _tslib.__assign)(
                {},
                this.variables,
    ...
    ObservableQuery.prototype.setVariables = function(
      ...
      if (
        !tryFetch &&
        (0, _apolloUtilities.isEqual)(variables, this.variables)
      ) {
    ...
    ObservableQuery.prototype.updateLastResult = function(newResult) {
      ...
      this.lastResultSnapshot = this.queryManager.assumeImmutableResults
        ? newResult
        : (0, _apolloUtilities.cloneDeep)(newResult);
    ...
    ObservableQuery.prototype.setUpQuery = function() {
      ...
      var onError = function(error) {
        _this.updateLastResult(
          (0, _tslib.__assign)({}, _this.lastResult, {
  ...
  var LocalState = (function() {
    ...
    LocalState.prototype.addResolvers = function(resolvers) {
      ...
      if (Array.isArray(resolvers)) {
        resolvers.forEach(function(resolverGroup) {
          _this.resolvers = (0, _apolloUtilities.mergeDeep)(
            _this.resolvers,
            resolverGroup,
          );
        });
      } else {
        this.resolvers = (0, _apolloUtilities.mergeDeep)(
          this.resolvers,
          resolvers,
        );
      }
    ...
    LocalState.prototype.serverQuery = function(document) {
      return this.resolvers
        ? (0, _apolloUtilities.removeClientSetsFromDocument)(document)
        : document;
    };
      ...
      var newContext = (0, _tslib.__assign)({}, context, {
        ...
        getCacheKey: function(obj) {
          if (cache.config) {
            ...
            process.env.NODE_ENV === 'production'
              ? (0, _tsInvariant.invariant)(false, 6)
              : (0, _tsInvariant.invariant)(
                  false,
          ...
          if (document) {
            return [
              ...
              this.resolveDocument(
                ...
                return (0,
                _tslib.__assign)({}, variables, data.exportedVariables);
              }),
            ];
          }
        ...
        return (0, _tslib.__generator)(this, function(_a) {
          ...
          execute = function(selection) {
            return (0, _tslib.__awaiter)(_this, void 0, void 0, function() {
              ...
              return (0, _tslib.__generator)(this, function(_a) {
                if (
                  !(0, _apolloUtilities.shouldInclude)(selection, variables)
                ) {
                  return [2];
                }
                      ...
                      function(fieldResult) {
                        ...
                        if (typeof fieldResult !== 'undefined') {
                          resultsToMerge.push(
                            ((_a = {}),
                            (_a[
                              (0, _apolloUtilities.resultKeyNameFromField)(
                                selection,
                              )
                            ] = fieldResult),
                            _a),
                ...
                if ((0, _apolloUtilities.isInlineFragment)(selection)) {
                  ...
                  process.env.NODE_ENV === 'production'
                    ? (0, _tsInvariant.invariant)(fragment, 7)
                    : (0, _tsInvariant.invariant)(
                        fragment,
    ...
    LocalState.prototype.resolveField = function(
      ...
      return (0, _tslib.__awaiter)(this, void 0, void 0, function() {
        ...
        return (0, _tslib.__generator)(this, function(_a) {
          ...
          aliasedFieldName = (0, _apolloUtilities.resultKeyNameFromField)(
            field,
          );
            ...
            if (resolverMap) {
              ...
              if (resolve) {
                resultPromise = Promise.resolve(
                  resolve(
                    rootValue,
                    (0, _apolloUtilities.argumentsObjectFromField)(
                      field,
                      variables,
                    ),
                    execContext.context,
  ...
  var QueryManager = (function() {
    function QueryManager(_a) {
      ...
      this.transformCache = new (_apolloUtilities.canUseWeakMap
        ? WeakMap
        : Map)();
    ...
    QueryManager.prototype.stop = function() {
      ...
      this.fetchQueryRejectFns.forEach(function(reject) {
        reject(
          process.env.NODE_ENV === 'production'
            ? new _tsInvariant.InvariantError(8)
            : new _tsInvariant.InvariantError(
      ...
      return (0, _tslib.__awaiter)(this, void 0, void 0, function() {
        ...
        return (0, _tslib.__generator)(this, function(_f) {
          switch (_f.label) {
            case 0:
              process.env.NODE_ENV === 'production'
                ? (0, _tsInvariant.invariant)(mutation, 9)
                : (0, _tsInvariant.invariant)(
                    mutation,
                ...
                new Promise(function(resolve, reject) {
                  ...
                  self
                    ...
                    .subscribe({
                      next: function(result) {
                        if (
                          (0, _apolloUtilities.graphQLResultHasError)(result) &&
                          errorPolicy === 'none'
                        ) {
                          error = new ApolloError({
                      ...
                      complete: function() {
                        ...
                        Promise.all(
                          ...
                          if (
                            errorPolicy === 'ignore' &&
                            storeResult &&
                            (0, _apolloUtilities.graphQLResultHasError)(
                              storeResult,
                            )
                          ) {
          ...
          switch (_e.label) {
            ...
            case 2:
              ...
              shouldFetch =
                ...
                fetchPolicy !== 'standby';
              if ((0, _apolloUtilities.hasDirectives)(['live'], query))
                shouldFetch = true;
    ...
    QueryManager.prototype.queryListenerForObserver = function(
      ...
      function invoke(method, argument) {
        if (observer[method]) {
          ...
          process.env.NODE_ENV === 'production' ||
            _tsInvariant.invariant.error(argument);
        }
      }
    ...
    QueryManager.prototype.transform = function(document) {
      ...
      if (!transformCache.has(document)) {
        ...
        var forLink = (0,
        _apolloUtilities.removeConnectionDirectiveFromDocument)(
        ...
        var cacheEntry_1 = {
          ...
          defaultVars: (0, _apolloUtilities.getDefaultValues)(
            (0, _apolloUtilities.getOperationDefinition)(transformed),
          ),
        };
    ...
    QueryManager.prototype.watchQuery = function(options, shouldSubscribe) {
      ...
      process.env.NODE_ENV === 'production'
        ? (0, _tsInvariant.invariant)(options.fetchPolicy !== 'standby', 11)
        : (0, _tsInvariant.invariant)(
    ...
    QueryManager.prototype.query = function(options) {
      ...
      process.env.NODE_ENV === 'production'
        ? (0, _tsInvariant.invariant)(options.query, 12)
        : (0, _tsInvariant.invariant)(
            options.query,
      ...
      process.env.NODE_ENV === 'production'
        ? (0, _tsInvariant.invariant)(options.query.kind === 'Document', 13)
        : (0, _tsInvariant.invariant)(
            options.query.kind === 'Document',
            'You must wrap the query string in a "gql" tag.',
          );
      process.env.NODE_ENV === 'production'
        ? (0, _tsInvariant.invariant)(!options.returnPartialData, 14)
        : (0, _tsInvariant.invariant)(
            !options.returnPartialData,
            'returnPartialData option only supported on watchQuery.',
          );
      process.env.NODE_ENV === 'production'
        ? (0, _tsInvariant.invariant)(!options.pollInterval, 15)
        : (0, _tsInvariant.invariant)(
    ...
    QueryManager.prototype.clearStore = function() {
      this.fetchQueryRejectFns.forEach(function(reject) {
        reject(
          process.env.NODE_ENV === 'production'
            ? new _tsInvariant.InvariantError(16)
            : new _tsInvariant.InvariantError(
    ...
    QueryManager.prototype.startQuery = function(queryId, options, listener) {
      process.env.NODE_ENV === 'production' ||
        _tsInvariant.invariant.warn(
          'The QueryManager.startQuery method has been deprecated',
        );
    ...
    QueryManager.prototype.startGraphQLSubscription = function(_a) {
      ...
      var makeObservable = function(variables) {
        return _this
          .getObservableFromLink(query, {}, variables, false)
          .map(function(result) {
    ...
    QueryManager.prototype.getQueryWithPreviousResult = function(
      ...
      if (typeof queryIdOrObservable === 'string') {
        var foundObserveableQuery = this.getQuery(queryIdOrObservable)
          .observableQuery;
        process.env.NODE_ENV === 'production'
          ? (0, _tsInvariant.invariant)(foundObserveableQuery, 17)
          : (0, _tsInvariant.invariant)(
    ...
    QueryManager.prototype.getObservableFromLink = function(
      ...
      if (serverQuery) {
        ...
        var operation = {
          ...
          variables: variables,
          operationName:
            (0, _apolloUtilities.getOperationName)(serverQuery) || void 0,
          ...
          if (!observable) {
            byVariables_1.set(
              ...
              (observable = multiplex(
                (0, _apolloLink.execute)(link, operation),
              )),
            );
    ...
    QueryManager.prototype.startPollingQuery = function(
      ...
      process.env.NODE_ENV === 'production'
        ? (0, _tsInvariant.invariant)(pollInterval, 18)
        : (0, _tsInvariant.invariant)(
            pollInterval,
  ...
  var DataStore = (function() {
    ...
    DataStore.prototype.markQueryResult = function(
      ...
      var writeWithErrors = !(0, _apolloUtilities.graphQLResultHasError)(
        result,
      );
      ...
      if (!(0, _apolloUtilities.graphQLResultHasError)(mutation.result)) {
        ...
        if (updateQueries_1) {
          Object.keys(updateQueries_1).forEach(function(id) {
            ...
            if (complete) {
              var nextQueryResult = (0, _apolloUtilities.tryFunctionOrLogError)(
                function() {
                  return updater(currentQueryResult, {
                    mutationResult: mutation.result,
                    queryName:
                      (0, _apolloUtilities.getOperationName)(query.document) ||
                      undefined,
    ...
    function ApolloClient(options) {
      ...
      if (!link || !cache) {
        throw process.env.NODE_ENV === 'production'
          ? new _tsInvariant.InvariantError(1)
          : new _tsInvariant.InvariantError(
