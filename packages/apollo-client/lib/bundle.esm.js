  ...
  ObservableQuery.prototype.fetchMore = function(fetchMoreOptions) {
    ...
    var combinedOptions = __assign(
      ...
      fetchMoreOptions.query
        ? fetchMoreOptions
        : __assign({}, this.options, fetchMoreOptions, {
        ...
        if (document) {
          return [
            ...
            this.resolveDocument(
              ...
              return __assign({}, remoteResult, { data: localResult.result });
            }),
          ];
        }
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_b) {
        ...
        execContext = {
          ...
          context: __assign({}, context, { cache: cache, client: client }),
          variables: variables,
    ...
    if (serverQuery) {
      ...
      var operation = {
        ...
        context: this.prepareContext(
          __assign({}, context, { forceFetch: !deduplication }),
        ),
      };
