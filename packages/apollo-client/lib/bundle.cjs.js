              ...
              queryManager
                ...
                .then(function(variables) {
                  ...
                  if (
                    ...
                    !(0, _apolloUtilities.isEqual)(previousVariables, variables)
                  ) {
                    _this.refetch();
                  } else {
...
var QueryStore = (function() {
  ...
  QueryStore.prototype.initQuery = function(query) {
    ...
    if (
      ...
      if (
        !(0, _apolloUtilities.isEqual)(previousQuery.variables, query.variables)
      ) {
        isSetVariables = true;
          ...
          return (0, _tslib.__awaiter)(_this, void 0, void 0, function() {
            ...
            return (0, _tslib.__generator)(this, function(_a) {
              ...
              if (fragment && fragment.typeCondition) {
                ...
                if (
                  execContext.fragmentMatcher(rootValue, typeCondition, context)
                ) {
                  return [
                    2,
                    this.resolveSelectionSet(
...
var QueryManager = (function() {
  ...
  QueryManager.prototype.transform = function(document) {
    ...
    if (!transformCache.has(document)) {
      ...
      var forLink = (0, _apolloUtilities.removeConnectionDirectiveFromDocument)(
