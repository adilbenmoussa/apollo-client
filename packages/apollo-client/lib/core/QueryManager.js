define([
  ...
  var QueryManager = (function() {
    function QueryManager(_a) {
      ...
      this.transformCache = new (apollo_utilities_1.canUseWeakMap
        ? WeakMap
        : Map)();
      ...
      this.localState =
        localState || new LocalState_1.LocalState({ cache: store.getCache() });
    ...
    QueryManager.prototype.stop = function() {
      ...
      this.fetchQueryRejectFns.forEach(function(reject) {
        reject(
          new ts_invariant_1.InvariantError(
                  ...
                  self
                    ...
                    .subscribe({
                      next: function(result) {
                        if (
                          apollo_utilities_1.graphQLResultHasError(result) &&
                          errorPolicy === 'none'
                        ) {
                      ...
                      complete: function() {
                        ...
                        Promise.all(
                          ...
                          if (
                            errorPolicy === 'ignore' &&
                            storeResult &&
                            apollo_utilities_1.graphQLResultHasError(
                              storeResult,
                            )
                          ) {
    ...
    QueryManager.prototype.queryListenerForObserver = function(
      ...
      return function(queryStoreValue, newData) {
        ...
        var loading = networkStatus_1.isNetworkRequestInFlight(
        ...
        var hasGraphQLErrors = arrays_1.isNonEmptyArray(
        ...
        try {
          ...
          invoke(
            'error',
            new ApolloError_1.ApolloError({ networkError: networkError }),
          );
        }
      };
    };
    QueryManager.prototype.transform = function(document) {
      ...
      if (!transformCache.has(document)) {
        ...
        var forLink = apollo_utilities_1.removeConnectionDirectiveFromDocument(
        ...
        var cacheEntry_1 = {
          ...
          defaultVars: apollo_utilities_1.getDefaultValues(
            apollo_utilities_1.getOperationDefinition(transformed),
          ),
        };
    ...
    QueryManager.prototype.getObservableFromLink = function(
      ...
      if (serverQuery) {
        ...
        var operation = {
          ...
          variables: variables,
          operationName:
            apollo_utilities_1.getOperationName(serverQuery) || void 0,
          context: this.prepareContext(
            tslib_1.__assign({}, context, { forceFetch: !deduplication }),
          ),
        };
        ...
        if (deduplication) {
          ...
          if (!observable) {
            byVariables_1.set(
              varJson_1,
              (observable = observables_1.multiplex(
                apollo_link_1.execute(link, operation),
              )),
            );
      ...
      return new Promise(function(resolve, reject) {
        ...
        var subscription = observable
          .map(function(result) {
            ...
            if (
              errorPolicy === 'none' &&
              arrays_1.isNonEmptyArray(result.errors)
            ) {
              return reject(
                new ApolloError_1.ApolloError({
                  graphQLErrors: result.errors,
    ...
    QueryManager.prototype.prepareContext = function(context) {
      ...
      return tslib_1.__assign({}, newContext, {
    ...
    QueryManager.prototype.startPollingQuery = function(
      ...
      if (!this.ssrMode) {
        ...
        info.options = tslib_1.__assign({}, options, {
          fetchPolicy: 'network-only',
        });
        var maybeFetch_1 = function() {
          ...
          if (info) {
            if (_this.checkInFlight(queryId)) {
              ...
              _this
                .fetchQuery(queryId, info.options, types_1.FetchType.poll)
                .then(poll_1, poll_1);
            }
          }
        };
