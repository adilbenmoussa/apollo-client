  ...
  exports.hasError = function(storeValue, policy) {
    ...
    return (
      ...
      (storeValue.networkError ||
        (policy === 'none' &&
          arrays_1.isNonEmptyArray(storeValue.graphQLErrors)))
    );
  };
  var ObservableQuery = (function(_super) {
    ...
    ObservableQuery.prototype.getCurrentResult = function() {
      ...
      if (queryStoreValue) {
        ...
        if (queryStoreValue.variables) {
          this.options.variables = tslib_1.__assign(
            {},
    ...
    ObservableQuery.prototype.refetch = function(variables) {
      ...
      return this.queryManager.fetchQuery(
        this.queryId,
        tslib_1.__assign({}, this.options, { fetchPolicy: fetchPolicy }),
        types_1.FetchType.refetch,
      );
    };
    ObservableQuery.prototype.fetchMore = function(fetchMoreOptions) {
      ...
      var combinedOptions = tslib_1.__assign(
        {},
        fetchMoreOptions.query
          ? fetchMoreOptions
          : tslib_1.__assign({}, this.options, fetchMoreOptions, {
              variables: tslib_1.__assign(
                {},
                this.variables,
    ...
    ObservableQuery.prototype.setUpQuery = function() {
      ...
      var onError = function(error) {
        _this.updateLastResult(
          tslib_1.__assign({}, _this.lastResult, {
