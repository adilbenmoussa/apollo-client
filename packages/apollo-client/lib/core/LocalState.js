define([
  ...
  var LocalState = (function() {
    ...
    LocalState.prototype.addResolvers = function(resolvers) {
      ...
      if (Array.isArray(resolvers)) {
        resolvers.forEach(function(resolverGroup) {
          _this.resolvers = apollo_utilities_1.mergeDeep(
            _this.resolvers,
            resolverGroup,
          );
        });
      } else {
        this.resolvers = apollo_utilities_1.mergeDeep(
          this.resolvers,
          resolvers,
        );
      }
          ...
          if (document) {
            return [
              ...
              this.resolveDocument(
                ...
                return tslib_1.__assign({}, remoteResult, {
    ...
    LocalState.prototype.serverQuery = function(document) {
      return this.resolvers
        ? apollo_utilities_1.removeClientSetsFromDocument(document)
        : document;
    };
    LocalState.prototype.prepareContext = function(context) {
      ...
      var newContext = tslib_1.__assign({}, context, {
        cache: cache,
          ...
          if (document) {
            return [
              ...
              this.resolveDocument(
                ...
                return tslib_1.__assign({}, variables, data.exportedVariables);
              }),
            ];
          }
      ...
      return tslib_1.__awaiter(this, void 0, void 0, function() {
        ...
        return tslib_1.__generator(this, function(_b) {
          ...
          execContext = {
            ...
            context: tslib_1.__assign({}, context, {
              cache: cache,
              client: client,
            }),
            variables: variables,
                      ...
                      function(fieldResult) {
                        ...
                        if (typeof fieldResult !== 'undefined') {
                          resultsToMerge.push(
                            ((_a = {}),
                            (_a[
                              apollo_utilities_1.resultKeyNameFromField(
                                selection,
                              )
                            ] = fieldResult),
                            _a),
            ...
            if (resolverMap) {
              ...
              if (resolve) {
                resultPromise = Promise.resolve(
                  resolve(
                    rootValue,
                    apollo_utilities_1.argumentsObjectFromField(
                      field,
                      variables,
                    ),
                    execContext.context,
