(exports.__esModule = !0), (exports.Cache = exports.ApolloCache = void 0);
    ...
    return (
      ...
      (n.prototype.readFragment = function(t, i) {
        return (
          void 0 === i && (i = !1),
          this.read({
            query: (0, e.getFragmentQueryDocument)(t.fragment, t.fragmentName),
      ...
      (n.prototype.writeData = function(e) {
        ...
        if (void 0 !== o) {
          var l = null;
          try {
            l = this.read({ rootId: o, optimistic: !1, query: r });
          } catch (e) {}
          var s = (l && l.__typename) || '__ClientData',
            d = Object.assign({ __typename: s }, u);
          this.writeFragment({
            id: o,
            fragment:
              ((n = d),
                ...
                definitions: [
                  {
                    ...
                    typeCondition: {
                      kind: 'NamedType',
                      name: { kind: 'Name', value: a || '__FakeType' },
                    },
                    name: { kind: 'Name', value: 'GeneratedClientQuery' },
                    selectionSet: i(n),
                  },
        ...
        } else this.writeQuery({ query: t(u), data: u });
      }),
      n
    );
  })();
(exports.ApolloCache = a), (exports.Cache = n), n || (exports.Cache = n = {});
