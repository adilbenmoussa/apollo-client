  ...
  describe('writing to the store', function() {
      ...
      expect(
        ...
        ((_a = {
          ROOT_QUERY: lodash_1.assign(
            {},
            lodash_1.assign({}, lodash_1.omit(result, 'nestedObj')),
            {
              nestedObj: {
                type: 'id',
    ...
    it('properly normalizes a nested array with IDs', function() {
      ...
      expect(
        ...
        ((_a = {
          ROOT_QUERY: lodash_1.assign(
            {},
            lodash_1.assign({}, lodash_1.omit(result, 'nestedArray')),
            {
              nestedArray: result.nestedArray.map(function(obj) {
                return {
                  type: 'id',
                  id: obj.id,
                  generated: false,
    ...
    it('properly normalizes an array of non-objects', function() {
      ...
      expect(normalized.toObject()).toEqual({
        ROOT_QUERY: lodash_1.assign(
          {},
          lodash_1.assign({}, lodash_1.omit(result, 'simpleArray')),
          {
            simpleArray: {
              type: 'json',
              json: [
    ...
    it('properly normalizes an array of non-objects with null', function() {
      var query = graphql_tag_1.default(
        templateObject_15 ||
          (templateObject_15 = tslib_1.__makeTemplateObject(
            [
              '\n      {\n        id\n        stringField\n        numberField\n        nullField\n        simpleArray\n      }\n    ',
            ],
            [
    ...
    it('properly normalizes an object occurring in different graphql paths twice', function() {
      var query = graphql_tag_1.default(
        templateObject_16 ||
          (templateObject_16 = tslib_1.__makeTemplateObject(
            [
              '\n      {\n        id\n        object1 {\n          id\n          stringField\n        }\n        object2 {\n          id\n          numberField\n        }\n      }\n    ',
            ],
            [
    ...
    it('properly normalizes an object occurring in different graphql array paths twice', function() {
      var query = graphql_tag_1.default(
        templateObject_17 ||
          (templateObject_17 = tslib_1.__makeTemplateObject(
            [
              '\n      {\n        id\n        array1 {\n          id\n          stringField\n          obj {\n            id\n            stringField\n          }\n        }\n        array2 {\n          id\n          stringField\n          obj {\n            id\n            numberField\n          }\n        }\n      }\n    ',
            ],
            [
    ...
    it('merges nodes', function() {
      var query = graphql_tag_1.default(
        templateObject_19 ||
          (templateObject_19 = tslib_1.__makeTemplateObject(
            [
              '\n      {\n        id\n        numberField\n        nullField\n      }\n    ',
            ],
            [
      ...
      var query2 = graphql_tag_1.default(
        templateObject_20 ||
          (templateObject_20 = tslib_1.__makeTemplateObject(
            [
              '\n      {\n        id\n        stringField\n        nullField\n      }\n    ',
            ],
            [
    ...
    it('properly normalizes an object with an ID when no extension is passed', function() {
      var query = graphql_tag_1.default(
        templateObject_22 ||
          (templateObject_22 = tslib_1.__makeTemplateObject(
            [
              '\n      {\n        people_one(id: "5") {\n          id\n          stringField\n        }\n      }\n    ',
            ],
            [
      ...
      var testData = [
        {
          mutation: graphql_tag_1.default(
            templateObject_23 ||
              (templateObject_23 = tslib_1.__makeTemplateObject(
                [
        ...
        },
        {
          mutation: graphql_tag_1.default(
            templateObject_24 ||
              (templateObject_24 = tslib_1.__makeTemplateObject(
                [
        ...
        },
        {
          mutation: graphql_tag_1.default(
            templateObject_25 ||
              (templateObject_25 = tslib_1.__makeTemplateObject(
                [
        ...
        },
        {
          mutation: graphql_tag_1.default(
            templateObject_26 ||
              (templateObject_26 = tslib_1.__makeTemplateObject(
                [
        ...
        },
        {
          mutation: graphql_tag_1.default(
            templateObject_27 ||
              (templateObject_27 = tslib_1.__makeTemplateObject(
                [
        ...
        },
        {
          mutation: graphql_tag_1.default(
            templateObject_28 ||
              (templateObject_28 = tslib_1.__makeTemplateObject(
                [
          ...
          if (isOperationDefinition(definition)) {
            definition.selectionSet.selections.forEach(function(selection) {
              if (isField(selection)) {
                expect(
                  apollo_utilities_1.storeKeyNameFromField(
                    selection,
                    data.variables,
                  ),
    ...
    it('properly normalizes a mutation with object or array parameters and variables', function() {
      var mutation = graphql_tag_1.default(
        templateObject_29 ||
          (templateObject_29 = tslib_1.__makeTemplateObject(
            [
    ...
    describe('type escaping', function() {
      ...
      it('should correctly escape generated ids', function() {
        var query = graphql_tag_1.default(
          templateObject_31 ||
            (templateObject_31 = tslib_1.__makeTemplateObject(
              [
                '\n        query {\n          author {\n            firstName\n            lastName\n          }\n        }\n      ',
              ],
              [
      ...
      it('should correctly escape real ids', function() {
        ...
        var query = graphql_tag_1.default(
          templateObject_32 ||
            (templateObject_32 = tslib_1.__makeTemplateObject(
              [
                '\n        query {\n          author {\n            firstName\n            id\n            __typename\n          }\n        }\n      ',
              ],
              [
      ...
      it('should correctly escape json blobs', function() {
        ...
        var query = graphql_tag_1.default(
          templateObject_33 ||
            (templateObject_33 = tslib_1.__makeTemplateObject(
              [
                '\n        query {\n          author {\n            info\n            id\n            __typename\n          }\n        }\n      ',
              ],
              [
    ...
    it('should merge objects when overwriting a generated id with a real id', function() {
      ...
      var queryWithoutId = graphql_tag_1.default(
        templateObject_34 ||
          (templateObject_34 = tslib_1.__makeTemplateObject(
            [
              '\n      query {\n        author {\n          firstName\n          lastName\n          __typename\n        }\n      }\n    ',
            ],
            [
      ...
      var queryWithId = graphql_tag_1.default(
        templateObject_35 ||
          (templateObject_35 = tslib_1.__makeTemplateObject(
            [
              '\n      query {\n        author {\n          firstName\n          id\n          __typename\n        }\n      }\n    ',
            ],
            [
    ...
    it('should allow a union of objects of a different type, when overwriting a generated id with a real id', function() {
      ...
      var query = graphql_tag_1.default(
        templateObject_36 ||
          (templateObject_36 = tslib_1.__makeTemplateObject(
            [
              '\n      query {\n        author {\n          ... on Author {\n            firstName\n            lastName\n            id\n            __typename\n          }\n          ... on Placeholder {\n            hello\n            __typename\n          }\n        }\n      }\n    ',
            ],
            [
    ...
    it('does not change object references if the value is the same', function() {
      var query = graphql_tag_1.default(
        templateObject_38 ||
          (templateObject_38 = tslib_1.__makeTemplateObject(
            [
              '\n      {\n        id\n        stringField\n        numberField\n        nullField\n      }\n    ',
            ],
            [
    ...
    describe('writeResultToStore shape checking', function() {
      var query = graphql_tag_1.default(
        templateObject_39 ||
          (templateObject_39 = tslib_1.__makeTemplateObject(
            [
              '\n      query {\n        todos {\n          id\n          name\n          description\n        }\n      }\n    ',
            ],
            [
      ...
      it('should warn when it receives the wrong data inside a fragment (using an introspection matcher)', function() {
        ...
        var queryWithInterface = graphql_tag_1.default(
          templateObject_40 ||
            (templateObject_40 = tslib_1.__makeTemplateObject(
              [
      ...
      it('should not warn if a field is defered', function() {
        ...
        var defered = graphql_tag_1.default(
          templateObject_41 ||
            (templateObject_41 = tslib_1.__makeTemplateObject(
              [
                '\n        query LazyLoad {\n          id\n          expensive @defer\n        }\n      ',
              ],
              [
      ...
      expect(function() {
        writer.writeQueryToStore({
          ...
          query: graphql_tag_1.default(
            templateObject_42 ||
              (templateObject_42 = tslib_1.__makeTemplateObject(
                [
                  '\n          query Failure {\n            item {\n              stringField\n            }\n          }\n        ',
                ],
                [
    ...
    it('properly handles the connection directive', function() {
      ...
      writer.writeQueryToStore({
        query: graphql_tag_1.default(
          templateObject_44 ||
            (templateObject_44 = tslib_1.__makeTemplateObject(
              [
      ...
      writer.writeQueryToStore({
        query: graphql_tag_1.default(
          templateObject_45 ||
            (templateObject_45 = tslib_1.__makeTemplateObject(
              [
    ...
    it('should keep reference when type of mixed inlined field changes', function() {
      ...
      var query = graphql_tag_1.default(
        templateObject_46 ||
          (templateObject_46 = tslib_1.__makeTemplateObject(
            [
              '\n      query {\n        animals {\n          species {\n            name\n          }\n        }\n      }\n    ',
            ],
            [
    ...
    it('should not keep reference when type of mixed inlined field changes to non-inlined field', function() {
      ...
      var query = graphql_tag_1.default(
        templateObject_47 ||
          (templateObject_47 = tslib_1.__makeTemplateObject(
            [
              '\n      query {\n        animals {\n          species {\n            id\n            name\n          }\n        }\n      }\n    ',
            ],
            [
