define([
  ...
  var fragmentMatcherFunction = new fragmentMatcher_1.HeuristicFragmentMatcher()
    .match;
  ...
  describe('diffing queries against the store', function() {
    ...
    it('caches root queries both under the ID of the node and the query name', function() {
      var firstQuery = graphql_tag_1.default(
        templateObject_4 ||
      ...
      var secondQuery = graphql_tag_1.default(
        templateObject_5 ||
    ...
    it('does not swallow errors other than field errors', function() {
      ...
      var unionQuery = graphql_tag_1.default(
        templateObject_7 ||
    ...
    it('returns available fields if returnPartialData is true', function() {
      ...
      var simpleQuery = graphql_tag_1.default(
        templateObject_15 ||
      ...
      var inlineFragmentQuery = graphql_tag_1.default(
        templateObject_16 ||
      ...
      var namedFragmentQuery = graphql_tag_1.default(
        templateObject_17 ||
    ...
    describe('referential equality preservation', function() {
      ...
      it('will preserve equality with custom resolvers', function() {
        var listQuery = graphql_tag_1.default(
          templateObject_27 ||
        ...
        var itemQuery = graphql_tag_1.default(
          templateObject_28 ||
    ...
    describe('malformed queries', function() {
      it('throws for non-scalar query fields without selection sets', function() {
        var validQuery = graphql_tag_1.default(
          templateObject_29 ||
        ...
        var invalidQuery = graphql_tag_1.default(
          templateObject_30 ||
