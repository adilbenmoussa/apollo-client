define([
  ...
  var StoreReader = (function() {
    function StoreReader(_a) {
      ...
      var _b = _a === void 0 ? {} : _a,
        ...
        cacheKeyRoot =
          _c === void 0
            ? new optimism_1.KeyTrie(apollo_utilities_1.canUseWeakMap)
            : _c,
        _d = _b.freezeResults,
      ...
      this.executeStoreQuery = optimism_1.wrap(
        function(options) {
        ...
        },
        {
          makeCacheKey: function(_a) {
            ...
            if (
              contextValue.store instanceof depTrackingCache_1.DepTrackingCache
            ) {
      ...
      this.executeSelectionSet = optimism_1.wrap(
        function(options) {
        ...
        },
        {
          makeCacheKey: function(_a) {
            ...
            if (
              execContext.contextValue.store instanceof
              depTrackingCache_1.DepTrackingCache
            ) {
              return cacheKeyRoot.lookup(
      ...
      this.executeSubSelectedArray = optimism_1.wrap(
        function(options) {
    ...
    StoreReader.prototype.readQueryFromStore = function(options) {
      return this.diffQueryAgainstStore(
        tslib_1.__assign({}, options, { returnPartialData: false }),
      ).result;
    };
    StoreReader.prototype.diffQueryAgainstStore = function(_a) {
      ...
      variables = apollo_utilities_1.assign(
        {},
        apollo_utilities_1.getDefaultValues(queryDefinition),
        variables,
      );
      var context = {
        store: store,
        ...
        if (apollo_utilities_1.isField(selection)) {
          ...
          if (typeof fieldResult !== 'undefined') {
            objectsToMerge.push(
              ((_a = {}),
              (_a[
                apollo_utilities_1.resultKeyNameFromField(selection)
              ] = fieldResult),
              _a),
            );
          }
    ...
    StoreReader.prototype.executeField = function(
      ...
      var info = {
        ...
        directives: apollo_utilities_1.getDirectiveInfoFromField(
          field,
          variables,
        ),
      };
  ...
  function assertIdValue(idValue) {
    ts_invariant_1.invariant(
      apollo_utilities_1.isIdValue(idValue),
  ...
  function readStoreResolver(object, typename, fieldName, args, context, _a) {
    ...
    if (args || directives) {
      storeKeyName = apollo_utilities_1.getStoreKeyName(
        storeKeyName,
        args,
        directives,
      );
