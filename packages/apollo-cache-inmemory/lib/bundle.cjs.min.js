(exports.__esModule = !0),
  (exports.assertIdValue = function(e) {
    (0, a.invariant)((0, r.isIdValue)(e), 11);
  }),
  (exports.defaultDataIdFromObject = R),
  (exports.defaultNormalizedCacheFactory = function(e) {
    return new m(e);
  }),
  (exports.enhanceErrorWithDocument = v),
...
var c = (function() {
  ...
  return (
    (e.prototype.match = function(e, t, r) {
      (0, a.invariant)(this.isReady, 1);
      var i = r.store.get(e.id),
        n = 'ROOT_QUERY' === e.id;
      if (!i) return n;
      var o = i.__typename,
        s = void 0 === o ? n && 'Query' : o;
      if (((0, a.invariant)(s, 2), s === t)) return !0;
  ...
  l = (function() {
    ...
    return (
      ...
      (e.prototype.delete = function(e) {
        u.call(this.data, e) && (delete this.data[e], this.depend.dirty(e));
      }),
  ...
  return (
    ...
    (t.prototype.diffQueryAgainstStore = function(e) {
      ...
      var h = {
        ...
        m = this.executeStoreQuery({
          query: i,
          rootValue: { type: 'id', id: l, generated: !0, typename: 'Query' },
          contextValue: h,
          variableValues: n,
          fragmentMatcher: d,
        }),
    ...
    (t.prototype.executeSelectionSet = function(t) {
      var i = this,
        ...
        p = [],
        f = u.store.get(o.id),
        h = (f && f.__typename) || ('ROOT_QUERY' === o.id && 'Query') || void 0;
      function m(e) {
        var t;
        return (
          e.missing &&
        ...
        n.selections.forEach(function(t) {
          ...
          if ((0, r.shouldInclude)(t, l))
            if ((0, r.isField)(t)) {
              ...
              void 0 !== d &&
                p.push((((n = {})[(0, r.resultKeyNameFromField)(t)] = d), n));
            } else {
              var y = void 0;
              if ((0, r.isInlineFragment)(t)) y = t;
              else if (!(y = c[t.name.value])) throw new a.InvariantError(9);
              var v = y.typeCondition && y.typeCondition.name.value,
                g = !v || s.fragmentMatcher(o, v, u);
              if (g) {
                var S = i.executeSelectionSet({
                ...
                'heuristic' === g &&
                  S.missing &&
                  (S = (0, e.__assign)({}, S, {
                    missing: S.missing.map(function(t) {
    ...
    (t.prototype.executeField = function(e, t, i, a) {
      var n = a.variableValues,
        ...
        s = (function(e, t, i, a, n, o) {
          ...
          (0, r.isJsonValue)(u) && (u = u.json);
          return { result: u };
        })(e, t, i.name.value, (0, r.argumentsObjectFromField)(i, n), o, {
...
function f(e, t) {
  if (!e.selectionSet && (0, r.isIdValue)(t)) throw new a.InvariantError(10);
}
function h() {
  return !0;
}
          ...
          if ((0, r.shouldInclude)(e, c))
            if ((0, r.isField)(e)) {
              ...
              (0, r.isInlineFragment)(e)
                ? (h = e)
                : ((h = (l || {})[e.name.value]), (0, a.invariant)(h, 3));
              var y = !0;
              if (s.fragmentMatcherFunction && h.typeCondition) {
                var v = n || 'self',
                  g = (0, r.toIdValue)({ id: v, typename: void 0 }),
                  S = {
                    store: new m(((o = {}), (o[v] = i), o)),
                    cacheRedirects: {},
                  },
                  b = s.fragmentMatcherFunction(
                    g,
                    h.typeCondition.name.value,
                    S,
                  );
                (0, r.isProduction)(), (y = !!b);
              }
              y &&
    ...
    (t.prototype.writeFieldToStore = function(t) {
      ...
      if (s.selectionSet && null !== c)
        if (Array.isArray(c)) {
          ...
          if ((S(y) || (y = '$' + y), p)) {
            var g = p(c);
            (0, a.invariant)(!g || !S(g), 4),
              (g || ('number' == typeof g && 0 === g)) && ((y = g), (v = !1));
          }
          b(y, s, l.processedData) ||
          ...
          var x = c.__typename;
          n = (0, r.toIdValue)({ id: y, typename: x }, v);
          var R = (o = f.get(u)) && o[h];
          if (R !== n && (0, r.isIdValue)(R)) {
            var I = void 0 !== R.typename,
              F = void 0 !== x,
              O = I && F && R.typename !== x;
            (0, a.invariant)(!v || R.generated || O, 5),
              (0, a.invariant)(!I || F, 6),
              R.generated &&
                (O
                  ? v || f.delete(R.id)
                  : (function t(i, a, n) {
                      ...
                      n.delete(i);
                      var u = (0, e.__assign)({}, o, s);
                      if ((0, r.isEqual)(u, s)) return c;
                      n.set(a, u);
                      return !0;
                    })(R.id, n.id, f));
          }
        ...
        n = null != c && 'object' == typeof c ? { type: 'json', json: c } : c;
...
var I = Object.prototype.hasOwnProperty,
  F = (function(t) {
    function r(e, r, i) {
      ...
      return (a.optimisticId = e), (a.parent = r), (a.transaction = i), a;
    }
    return (
      (0, e.__extends)(r, t),
      ...
      (r.prototype.get = function(e) {
        return I.call(this.data, e) ? this.data[e] : this.parent.get(e);
      }),
      r
    );
  })(m),
  O = (function(t) {
    function n(a) {
      ...
      (n.watches = new Set()),
        ...
        (n.data = n.config.resultCaching ? new l() : new m()),
            ...
            makeCacheKey: function(e) {
              if (!e.optimistic && !e.previousResult)
                return o.data instanceof l
                  ? o.cacheKeyRoot.lookup(e.query, JSON.stringify(e.variables))
                  : void 0;
            },
          },
        )),
    ...
    return (
      ...
      (n.prototype.read = function(e) {
        if ('string' == typeof e.rootId && void 0 === this.data.get(e.rootId))
          return null;
      ...
      (n.prototype.performTransaction = function(e, t) {
        ...
        (this.silenceBroadcast = !0),
          'string' == typeof t &&
            (this.data = this.optimisticData = new F(
              t,
              this.optimisticData,
              e,
            ));
