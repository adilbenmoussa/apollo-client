...
var StoreReader = (function() {
  ...
  StoreReader.prototype.readQueryFromStore = function(options) {
    return this.diffQueryAgainstStore(
      __assign({}, options, { returnPartialData: false }),
    ).result;
  };
        ...
        if (isInlineFragment(selection)) {
          ...
          if (!fragment) {
            throw process.env.NODE_ENV === 'production'
              ...
              : new InvariantError('No fragment named ' + selection.name.value);
          }
        }
        var typeCondition =
...
function assertIdValue(idValue) {
  process.env.NODE_ENV === 'production'
    ? invariant(isIdValue(idValue), 11)
    : invariant(
        isIdValue(idValue),
  ...
  StoreWriter.prototype.writeFieldToStore = function(_a) {
    ...
    if (!field.selectionSet || value === null) {
      ...
      if (dataIdFromObject) {
        ...
        process.env.NODE_ENV === 'production'
          ? invariant(!semanticId || !isGeneratedId(semanticId), 4)
          : invariant(
      ...
      if (escapedId !== storeValue && isIdValue(escapedId)) {
        ...
        process.env.NODE_ENV === 'production'
          ? invariant(!generated || escapedId.generated || typenameChanged, 5)
          : invariant(
        ...
        process.env.NODE_ENV === 'production'
          ? invariant(!hadTypename || hasTypename, 6)
          : invariant(
