define([
  ...
  var StoreWriter = (function() {
    ...
    StoreWriter.prototype.writeQueryToStore = function(_a) {
      var query = _a.query,
        ...
        store =
          _b === void 0
            ? depTrackingCache_1.defaultNormalizedCacheFactory()
            : _b,
    ...
    StoreWriter.prototype.writeResultToStore = function(_a) {
      var dataId = _a.dataId,
        ...
        dataIdFromObject = _a.dataIdFromObject,
        fragmentMatcherFunction = _a.fragmentMatcherFunction;
      var operationDefinition = apollo_utilities_1.getOperationDefinition(
        document,
      );
      try {
        return this.writeSelectionSetToStore({
          ...
          context: {
            store: store,
            processedData: {},
            variables: apollo_utilities_1.assign(
              {},
              apollo_utilities_1.getDefaultValues(operationDefinition),
              variables,
            ),
            dataIdFromObject: dataIdFromObject,
            fragmentMap: apollo_utilities_1.createFragmentMap(
              apollo_utilities_1.getFragmentDefinitions(document),
            ),
            fragmentMatcherFunction: fragmentMatcherFunction,
          },
        });
    ...
    StoreWriter.prototype.writeSelectionSetToStore = function(_a) {
      ...
      selectionSet.selections.forEach(function(selection) {
        ...
        if (apollo_utilities_1.isField(selection)) {
          var resultFieldKey = apollo_utilities_1.resultKeyNameFromField(
            selection,
          );
          ...
          if (context.fragmentMatcherFunction && fragment.typeCondition) {
            var id = dataId || 'self';
            var idValue = apollo_utilities_1.toIdValue({
              id: id,
              typename: undefined,
            });
            var fakeContext = {
              store: new objectCache_1.ObjectCache(
                ((_a = {}), (_a[id] = result), _a),
              ),
              cacheRedirects: {},
            };
            ...
            if (!apollo_utilities_1.isProduction() && match === 'heuristic') {
              ts_invariant_1.invariant.error(
    ...
    StoreWriter.prototype.writeFieldToStore = function(_a) {
      ...
      var storeValue;
      var storeObject;
      var storeFieldName = apollo_utilities_1.storeKeyNameFromField(
        field,
        variables,
      );
      if (!field.selectionSet || value === null) {
        ...
        storeValue = apollo_utilities_1.toIdValue(
      ...
      if (
        !storeObject ||
        !apollo_utilities_1.isEqual(storeValue, storeObject[storeFieldName])
      ) {
        store.set(
          dataId,
          tslib_1.__assign(
  ...
  function mergeWithGenerated(generatedKey, realKey, cache) {
    ...
    Object.keys(generated).forEach(function(key) {
      ...
      if (
        apollo_utilities_1.isIdValue(value) &&
