(function(global, factory) {
  ...
  var IntrospectionFragmentMatcher = (function() {
    ...
    IntrospectionFragmentMatcher.prototype.match = function(
      ...
      process.env.NODE_ENV === 'production'
        ? (0, _tsInvariant.invariant)(this.isReady, 1)
      ...
      process.env.NODE_ENV === 'production'
        ? (0, _tsInvariant.invariant)(__typename, 2)
        : (0, _tsInvariant.invariant)(
            __typename,
  ...
  var StoreReader = (function() {
    function StoreReader(_a) {
      ...
      var _b = _a === void 0 ? {} : _a,
        ...
        cacheKeyRoot =
          _c === void 0
            ? new _optimism.KeyTrie(_apolloUtilities.canUseWeakMap)
            : _c,
        _d = _b.freezeResults,
      ...
      this.executeStoreQuery = (0, _optimism.wrap)(
        function(options) {
      ...
      this.executeSelectionSet = (0, _optimism.wrap)(
        function(options) {
      ...
      this.executeSubSelectedArray = (0, _optimism.wrap)(
        function(options) {
    ...
    StoreReader.prototype.diffQueryAgainstStore = function(_a) {
      ...
      variables = (0, _apolloUtilities.assign)(
        {},
        (0, _apolloUtilities.getDefaultValues)(queryDefinition),
        variables,
      );
      var context = {
        store: store,
        ...
        if ((0, _apolloUtilities.isField)(selection)) {
          ...
          if (typeof fieldResult !== 'undefined') {
            objectsToMerge.push(
              ((_a = {}),
              (_a[
                (0, _apolloUtilities.resultKeyNameFromField)(selection)
              ] = fieldResult),
              _a),
            );
          }
          ...
          if ((0, _apolloUtilities.isInlineFragment)(selection)) {
            ...
            if (!fragment) {
              throw process.env.NODE_ENV === 'production'
                ? new _tsInvariant.InvariantError(9)
                : new _tsInvariant.InvariantError(
          ...
          if (match) {
            ...
            if (match === 'heuristic' && fragmentExecResult.missing) {
              fragmentExecResult = (0, _tslib.__assign)(
                {},
                fragmentExecResult,
                {
    ...
    StoreReader.prototype.executeField = function(
      ...
      var args = (0, _apolloUtilities.argumentsObjectFromField)(
        field,
        variables,
      );
      var info = {
        resultKey: (0, _apolloUtilities.resultKeyNameFromField)(field),
        directives: (0, _apolloUtilities.getDirectiveInfoFromField)(
          field,
          variables,
        ),
      };
  ...
  function assertSelectionSetForIdValue(field, value) {
    if (!field.selectionSet && (0, _apolloUtilities.isIdValue)(value)) {
      throw process.env.NODE_ENV === 'production'
        ? new _tsInvariant.InvariantError(10)
        : new _tsInvariant.InvariantError(
  ...
  function assertIdValue(idValue) {
    process.env.NODE_ENV === 'production'
      ? (0, _tsInvariant.invariant)(
          (0, _apolloUtilities.isIdValue)(idValue),
          11,
        )
      : (0, _tsInvariant.invariant)(
          (0, _apolloUtilities.isIdValue)(idValue),
  ...
  function readStoreResolver(object, typename, fieldName, args, context, _a) {
    ...
    if (args || directives) {
      storeKeyName = (0, _apolloUtilities.getStoreKeyName)(
        storeKeyName,
        args,
        directives,
      );
  ...
  var StoreWriter = (function() {
    ...
    StoreWriter.prototype.writeResultToStore = function(_a) {
      var dataId = _a.dataId,
        ...
        dataIdFromObject = _a.dataIdFromObject,
        fragmentMatcherFunction = _a.fragmentMatcherFunction;
      var operationDefinition = (0, _apolloUtilities.getOperationDefinition)(
        document,
      );
      ...
      try {
        return this.writeSelectionSetToStore({
          ...
          context: {
            ...
            variables: (0, _apolloUtilities.assign)(
              {},
              (0, _apolloUtilities.getDefaultValues)(operationDefinition),
              variables,
            ),
            dataIdFromObject: dataIdFromObject,
            fragmentMap: (0, _apolloUtilities.createFragmentMap)(
              (0, _apolloUtilities.getFragmentDefinitions)(document),
            ),
            fragmentMatcherFunction: fragmentMatcherFunction,
          },
        });
    ...
    StoreWriter.prototype.writeSelectionSetToStore = function(_a) {
      ...
      selectionSet.selections.forEach(function(selection) {
        ...
        if ((0, _apolloUtilities.isField)(selection)) {
          var resultFieldKey = (0, _apolloUtilities.resultKeyNameFromField)(
            selection,
          );
          ...
          if ((0, _apolloUtilities.isInlineFragment)(selection)) {
            ...
            fragment = (fragmentMap || {})[selection.name.value];
            process.env.NODE_ENV === 'production'
              ? (0, _tsInvariant.invariant)(fragment, 3)
              : (0, _tsInvariant.invariant)(
                  fragment,
                  'No fragment named ' + selection.name.value + '.',
                );
          ...
          if (context.fragmentMatcherFunction && fragment.typeCondition) {
            ...
            if (
              !(0, _apolloUtilities.isProduction)() &&
              match === 'heuristic'
            ) {
              process.env.NODE_ENV === 'production' ||
                _tsInvariant.invariant.error(
    ...
    StoreWriter.prototype.writeFieldToStore = function(_a) {
      ...
      var storeValue;
      var storeObject;
      var storeFieldName = (0, _apolloUtilities.storeKeyNameFromField)(
        field,
        variables,
      );
      ...
      if (!field.selectionSet || value === null) {
        ...
        if (
          ...
          (0, _apolloUtilities.isIdValue)(escapedId)
        ) {
          ...
          process.env.NODE_ENV === 'production'
            ? (0, _tsInvariant.invariant)(!hadTypename || hasTypename, 6)
            : (0, _tsInvariant.invariant)(
      ...
      if (
        !storeObject ||
        !(0, _apolloUtilities.isEqual)(storeValue, storeObject[storeFieldName])
      ) {
        store.set(
          dataId,
          (0, _tslib.__assign)(
  ...
  function mergeWithGenerated(generatedKey, realKey, cache) {
    ...
    Object.keys(generated).forEach(function(key) {
      ...
      if (
        (0, _apolloUtilities.isIdValue)(value) &&
        isGeneratedId(value.id) &&
        (0, _apolloUtilities.isIdValue)(realValue) &&
        !(0, _apolloUtilities.isEqual)(value, realValue) &&
  ...
  var InMemoryCache = (function(_super) {
    ...
    function InMemoryCache(config) {
      ...
      _this.cacheKeyRoot = new _optimism.KeyTrie(
        _apolloUtilities.canUseWeakMap,
      );
      ...
      _this.maybeBroadcastWatch = (0, _optimism.wrap)(
        function(c) {
    ...
    InMemoryCache.prototype.evict = function(query) {
      throw process.env.NODE_ENV === 'production'
        ? new _tsInvariant.InvariantError(7)
        : new _tsInvariant.InvariantError(
