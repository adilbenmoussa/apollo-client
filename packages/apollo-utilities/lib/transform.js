define([
  ...
  function nullIfDocIsEmpty(doc) {
    return isEmpty(
      getFromAST_1.getOperationDefinition(doc) ||
        getFromAST_1.getFragmentDefinition(doc),
      getFromAST_1.createFragmentMap(getFromAST_1.getFragmentDefinitions(doc)),
    )
      ? null
      : doc;
  }
  ...
  function removeDirectivesFromDocument(directives, doc) {
    ...
    if (
      modifiedDoc &&
      filterInPlace_1.filterInPlace(variablesToRemove, function(v) {
    ...
    if (
      modifiedDoc &&
      filterInPlace_1.filterInPlace(fragmentSpreadsToRemove, function(fs) {
      ...
      SelectionSet: {
        enter: function(node, _key, parent) {
          ...
          var skip = selections.some(function(selection) {
            return (
              storeUtils_1.isField(selection) &&
  ...
  function getAllFragmentSpreadsFromSelectionSet(selectionSet) {
    ...
    selectionSet.selections.forEach(function(selection) {
      if (
        (storeUtils_1.isField(selection) ||
          storeUtils_1.isInlineFragment(selection)) &&
        selection.selectionSet
      ) {
