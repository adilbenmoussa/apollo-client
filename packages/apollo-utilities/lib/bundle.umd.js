(function(global, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(
      ...
      global.tsInvariant,
      global.tslib,
      global.fastJsonStableStringify,
      global.equality,
    );
  ...
  function isScalarValue(value) {
    return (
      ['StringValue', 'BooleanValue', 'EnumValue'].indexOf(value.kind) > -1
    );
  }
  ...
  function valueToObjectRepresentation(argObj, name, value, variables) {
    if (isIntValue(value) || isFloatValue(value)) {
      ...
      throw process.env.NODE_ENV === 'production'
        ? new _tsInvariant.InvariantError(17)
  ...
  function defaultValueFromVariable(node) {
    throw process.env.NODE_ENV === 'production'
      ? new _tsInvariant.InvariantError(18)
      : new _tsInvariant.InvariantError(
  ...
  function getDirectiveInfoFromField(field, variables) {
    if (field.directives && field.directives.length) {
      var directiveObj_1 = {};
      field.directives.forEach(function(directive) {
        directiveObj_1[directive.name.value] = argumentsObjectFromField(
          directive,
          variables,
        );
      });
    ...
    return getInclusionDirectives(selection.directives).every(function(_a) {
      ...
      if (ifArgument.value.kind === 'Variable') {
        ...
        process.env.NODE_ENV === 'production'
          ? (0, _tsInvariant.invariant)(evaledValue !== void 0, 1)
  ...
  function getInclusionDirectives(directives) {
    return directives
      ? directives.filter(isInclusionDirective).map(function(directive) {
  ...
  function getFragmentQueryDocument(document, fragmentName) {
    ...
    document.definitions.forEach(function(definition) {
      if (definition.kind === 'OperationDefinition') {
        throw process.env.NODE_ENV === 'production'
          ? new _tsInvariant.InvariantError(5)
          : new _tsInvariant.InvariantError(
              'Found a ' +
    ...
    if (typeof actualFragmentName === 'undefined') {
      process.env.NODE_ENV === 'production'
        ? (0, _tsInvariant.invariant)(fragments.length === 1, 6)
        : (0, _tsInvariant.invariant)(
            fragments.length === 1,
            'Found ' +
              fragments.length +
  ...
  function getMutationDefinition(doc) {
    ...
    process.env.NODE_ENV === 'production'
      ? (0, _tsInvariant.invariant)(mutationDef, 7)
      : (0, _tsInvariant.invariant)(
          mutationDef,
          'Must contain a mutation definition.',
        );
    return mutationDef;
  }
  ...
  function checkDocument(doc) {
    process.env.NODE_ENV === 'production'
      ? (0, _tsInvariant.invariant)(doc && doc.kind === 'Document', 8)
      : (0, _tsInvariant.invariant)(
    ...
    process.env.NODE_ENV === 'production'
      ? (0, _tsInvariant.invariant)(operations.length <= 1, 10)
      : (0, _tsInvariant.invariant)(
          operations.length <= 1,
  ...
  function getOperationDefinitionOrDie(document) {
    ...
    process.env.NODE_ENV === 'production'
      ? (0, _tsInvariant.invariant)(def, 11)
      : (0, _tsInvariant.invariant)(
          def,
          'GraphQL document is missing an operation',
        );
    return def;
  }
  ...
  function getFragmentDefinition(doc) {
    process.env.NODE_ENV === 'production'
      ? (0, _tsInvariant.invariant)(doc.kind === 'Document', 13)
      : (0, _tsInvariant.invariant)(
          doc.kind === 'Document',
          'Expecting a parsed GraphQL document. Perhaps you need to wrap the query string in a "gql" tag? http://docs.apollostack.com/apollo-client/core.html#gql',
        );
    process.env.NODE_ENV === 'production'
      ? (0, _tsInvariant.invariant)(doc.definitions.length <= 1, 14)
      : (0, _tsInvariant.invariant)(
  ...
  function variablesInOperation(operation) {
    ...
    if (operation.variableDefinitions) {
      for (
        var _i = 0, _a = operation.variableDefinitions;
        _i < _a.length;
        _i++
      ) {
        var definition = _a[_i];
        ...
        SelectionSet: {
          enter: function(node, _key, _parent, path) {
            ...
            if (
              ...
              if (node.selections) {
                var selectionsWithDirectives = node.selections.filter(function(
                  selection,
                ) {
    ...
    return nullIfDocIsEmpty(
      (0, _visitor.visit)(doc, {
        OperationDefinition: {
          enter: function(node) {
            return (0, _tslib.__assign)({}, node, {
              variableDefinitions: node.variableDefinitions.filter(function(
                varDef,
              ) {
