...
export declare type StoreValue =
  ...
  | void
  | Object;
export declare type ScalarValue =
  | StringValueNode
  | BooleanValueNode
  | EnumValueNode;
...
export declare function valueToObjectRepresentation(
  argObj: any,
  name: NameNode,
  value: ValueNode,
  variables?: Object,
): void;
export declare function storeKeyNameFromField(
  field: FieldNode,
  variables?: Object,
): string;
...
export declare function getStoreKeyName(
  fieldName: string,
  args?: Object,
  directives?: Directives,
): string;
export declare function argumentsObjectFromField(
  field: FieldNode | DirectiveNode,
  variables: Object,
): Object;
export declare function resultKeyNameFromField(field: FieldNode): string;
export declare function isField(
  selection: SelectionNode,
): selection is FieldNode;
export declare function isInlineFragment(
  selection: SelectionNode,
...
export declare function toIdValue(
...
export declare function valueFromNode(
  node: ValueNode,
