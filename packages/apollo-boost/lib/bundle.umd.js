(function(global, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(
      ...
      global.apolloClient,
      global.apolloLink,
      global.apolloCacheInmemory,
      global.apolloLinkHttp,
      global.apolloLinkError,
      global.graphqlTag,
      global.tsInvariant,
    );
  ...
  var DefaultClient = (function(_super) {
    ...
    function DefaultClient(config) {
      ...
      process.env.NODE_ENV === 'production'
        ? (0, _tsInvariant.invariant)(!cache || !cacheRedirects, 1)
      ...
      var errorLink = errorCallback
        ? (0, _apolloLinkError.onError)(errorCallback)
        : (0, _apolloLinkError.onError)(function(_a) {
            ...
            if (networkError) {
              process.env.NODE_ENV === 'production' ||
                _tsInvariant.invariant.warn('[Network error]: ' + networkError);
            }
          });
      var requestHandler = request
        ? new _apolloLink.ApolloLink(function(operation, forward) {
